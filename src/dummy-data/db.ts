// This file contains dummy data for the chat application, including:
// - conversations: An array of conversation objects with details like participants, last message, etc.
